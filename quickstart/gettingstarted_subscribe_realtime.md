...
For information about device connection and data ingestion, see [Device Connection](/docs/device-connection/en/2.0.8/quickstart/gettingstarted_device_connection.html).
