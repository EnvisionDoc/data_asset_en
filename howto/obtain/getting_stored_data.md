...
For more information about how to work with EnOS SDK, see [Getting Started with EnOS SDKs](/docs/app-development/en/2.0.8/gettingstarted_sdk.html).
...
For more information about how to use EnOS API, see [Getting Started with EnOS REST APIs](/docs/app-development/en/2.0.8/gettingstarted_api.html).
