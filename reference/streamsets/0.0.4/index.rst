Calculator Library 0.0.4 Documentation
=============================================

The Streaming Calculator Library 0.0.4 includes operators for asset information query, data aggregation, exception interpolation, event-time-based time window aggregation, and threshold filtering.
