...
This stage captures the data that passes through this stage and store the data in Redis in the `key:field:value` format. The format of the Redis key is `pipelineId::commonRedisStage::assetId`, in which `commonRedisStage` is a fixed field.
