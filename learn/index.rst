...
-----------------------------------
EnOS Stream Analytics provides a set of underlying packaged StreamSets operators for developers to design customized stream data processing jobs to meet the requirements of complex business scenarios. For more information, see `StreamSets Operator Reference <../reference/streamsets/index>`__.
